...
const socialLinks = [
  {
    ...
    subText: "@lucas_garcia3528",
    icon: Instagram,
    url: "https://www.instagram.com/lucas_garcia3528/",
    color: "#E4405F",
  ...
  },
  {
    ...
    subText: "@Garcia3528",
    icon: Github,
    url: "https://github.com/Garcia3528",
    color: "#ffffff",
...
const SocialLinks = () => {
  const instagram = socialLinks.find(link => link.isPrimary);
